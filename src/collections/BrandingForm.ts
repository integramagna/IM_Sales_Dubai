...
export const BrandingForm: CollectionConfig = {
  slug: 'branding-forms',
  admin: {
    useAsTitle: 'fullName',
      ...
      async ({ doc, operation }) => {
        ...
        if (adminEmail) {
          sendBrevo({
            ...
            subject: `📩 New Branding Enquiry — ${doc.fullName}`,
            htmlContent: `
              <h2 style="color:#333;font-family:sans-serif">New Branding Form Submission</h2>
