...
export const PackagingForm: CollectionConfig = {
      ...
      async ({ doc, operation }) => {
        ...
        if (adminEmail) {
          sendBrevo({
            ...
            subject: `📩 New Packaging Enquiry — ${doc.fullName}`,
            htmlContent: `
              <h2 style="color:#333;font-family:sans-serif">New Packaging Form Submission</h2>
