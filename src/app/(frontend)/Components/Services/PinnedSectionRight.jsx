...
import stylesPinSection from "./PinnedSectionRight.module.css"; 
    ...
    if (!isMobile) {
      ...
      detailTriggers = details.map((detail, index) => {
        return ScrollTrigger.create({
          ...
          onEnter: () => gsap.to(photos[index], { autoAlpha: 1, duration: 0.2 }),
          onLeave: () => gsap.to(photos[index], { autoAlpha: 0, duration: 0.2 }),
          onEnterBack: () => gsap.to(photos[index], { autoAlpha: 1, duration: 0.2 }),
          onLeaveBack: () => {
            index === 0
