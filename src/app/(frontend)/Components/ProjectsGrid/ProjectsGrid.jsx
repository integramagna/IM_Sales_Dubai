...
const projects = [
  {
    ...
    title: 'Royal Legacy',
    tags: 'Branding | Food',
    description: 'UI/UX Design and Mobile Application Development crafted for Royal Legacy.',
    popupImages: [
  ...
  },
  {
    ...
    description: 'Complete branding identity and UI/UX design system for Prestige University.',
    popupImages: [
  ...
  },
  {
    ...
    description: 'Branding and UI/UX design for the Motivata Festboard experience.',
    popupImages: [
  ...
  },
  {
    ...
    popupImages: [
     ...
     { type: 'landscape', src: '/assets/images/projects/hari/1.webp' },
      { type: 'double',    src: ['/assets/images/projects/hari/2.webp', '/assets/images/projects/hari/3.webp'] },
      { type: 'square',   src: '/assets/images/projects/hari/4.webp' },
      { type: 'double',    src: ['/assets/images/projects/hari/5.webp', '/assets/images/projects/hari/6.webp'] },
 ...
 { type: 'landscape', src: '/assets/images/projects/satva/1.webp' },
      { type: 'double',    src: ['/assets/images/projects/satva/2.webp', '/assets/images/projects/satva/3.webp'] },
      { type: 'square',   src: '/assets/images/projects/satva/4.webp' },
      { type: 'double',    src: ['/assets/images/projects/satva/5.webp', '/assets/images/projects/satva/6.webp'] },
...
<Image src={project.src} alt={project.title} fill sizes="(max-width: 768px) 100vw, 50vw" style={{ objectFit: 'cover' }} />
  ...
  >
    <div className={styles.exploreCursorCircle}>
      <span className={styles.exploreCursorText}>
        Explore
      </span>
    </div>
  </div>
