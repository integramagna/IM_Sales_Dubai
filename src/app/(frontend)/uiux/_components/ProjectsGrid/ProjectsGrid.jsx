...
const projects = [
  ...
  },
  {
    ...
    description: 'Transforming bold ideas into engaging digital journeys designed to inspire action and connection.',
    popupImages: [
  ...
  },
  {
    ...
    description: 'Elevating luxury interiors through an immersive digital experience that reflects timeless sophistication.',
    popupImages: [
  ...
  },
  {
    ...
    description: 'Creating a compassionate healthcare platform that makes care accessible, trusted, and easy to navigate.',
    popupImages: [
