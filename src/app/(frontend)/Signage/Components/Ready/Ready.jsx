        ...
        <div className={styles.card}>
          <div className={styles.content}>
            <div className={styles.headingDesc}>
              <h2 className={styles.heading}>Ready to Make Your Business Impossible to Ignore?</h2>
              <p className={styles.description}>
                Join 500+ UAE businesses who trust Rabtora to deliver signage that commands
                attention, builds authority, and drives real results.
              </p>
            </div>
            <button
              type="button"
